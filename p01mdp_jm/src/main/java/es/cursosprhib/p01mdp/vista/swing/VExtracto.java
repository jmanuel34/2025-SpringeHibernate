package es.cursosprhib.p01mdp.vista.swing;
...
public class VExtracto extends JFrame {
	...
	VExtracto(GeneraExtracto neg, Cliente clienteActual, VInicial padre) {
		super(TITULO);
		setResizable(false);
		...
		nombre = new JLabel(clienteActual.getNombreYApellidos());
